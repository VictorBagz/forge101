...
import { 
  Activity, Users, Clock, MapPin, Instagram, Facebook, Twitter, Phone, Mail,
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-forge-accent transition-colors"><Facebook size={20} /></a>
